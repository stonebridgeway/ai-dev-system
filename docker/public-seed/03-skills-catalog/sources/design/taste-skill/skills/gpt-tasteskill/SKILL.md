---
name: gpt-taste
description: Use when designing or implementing high-variance landing pages that need strict AIDA structure, editorial typography, gapless bento grids, and advanced GSAP ScrollTrigger motion.
---
