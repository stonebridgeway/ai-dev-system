...
description: Use when a project requires exact backward compatibility with the original v1 frontend taste behavior; otherwise use the substantially rewritten `design-taste-frontend` v2 skill.
---
