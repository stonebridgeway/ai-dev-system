...
1. Restate the request as one sentence with scope, non-goals, and an observable result. If one of those is unknown and materially changes the work, ask one focused question. Then resolve the real repository root and read `AGENTS.md` when present.
